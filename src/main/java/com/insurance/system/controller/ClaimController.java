...
public class ClaimController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Claim> getById(@NotNull @PathVariable Long id) {
        log.info("Entered into getById method in claimController");
    ...
    {
        log.info("Entered into getAll method in claim controller");
